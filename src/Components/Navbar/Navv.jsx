        ...
        <ul className="main-menu ">
          ...
          <li  onClick={subHandler} className="dropbtn" >
            ...
            <div className="dropdown-content">
              <NavLink to="/about" onClick={lHandler}>About Institute</NavLink>
              <NavLink to="/about1" onClick={lHandler}>About Universal Innovators</NavLink>
            </div>
          </li>
          ...
          <li  onClick={subHandler} className="dropbtn">
            ...
            Papers
            <div className="dropdown-content">
              <NavLink to="/callForPapers" onClick={lHandler}>Call for Papers</NavLink>
              <NavLink to="/paperSubmissions" onClick={lHandler}>Paper Submissions</NavLink>
              <NavLink to="/callForSpecial" onClick={lHandler}>Call for Special</NavLink>
              <NavLink to="/callForInternational" onClick={lHandler}>Call for International Workshops</NavLink>
            </div>
            </li>
...
<NavLink to="/publications">Publications</NavLink>
          ...
          <li  onClick={subHandler} className="dropbtn">
            ...
            Committe
            <div className="dropdown-content">
            <NavLink to="/steerings" onClick={lHandler}>Steering Committee</NavLink>
            <NavLink to="/technicals" onClick={lHandler}>Technical Program Committee</NavLink>
            <NavLink to="/advisorys" onClick={lHandler}>Advisory Committee</NavLink>
